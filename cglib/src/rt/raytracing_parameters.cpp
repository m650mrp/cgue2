...
static TwEnumVal scene_enum[] = {
	...
	{ RaytracingParameters::SPHERE_REFLECTION, "Sphere Reflection" },
};
...
derived_gui_setup(TwBar* bar)
{
	...
	TwAddVarRW(bar, "spot_light", TW_TYPE_BOOLCPP, &spot_light, "label='Spotlight' group='SpotLight Settings'");
